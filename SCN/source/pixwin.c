...
int width, height;
{
    ...
    STWindowExists = TRUE;	/* window now exists, more or less */
...
DoDispatch()
{
    if (STWindowExists == FALSE)	/* nothing to dispatch on 	    */
        return;
