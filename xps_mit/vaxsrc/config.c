...
static int SizeArray = 53, SizeMark = 19, SizeBool = 53, SizeNull = 19;
...
Type Array, Mark, Bool, Dictionary, Condition, Null, File, Integer;
Type Real, Name, Operator, String, Poly, Float, FontID;

extern Object Absent, SysDict;
Object Nil;

#ifdef MACINTOSH
char default_library[] = "";
#else
/* This should come out of an environment variable.... - AMG */
char default_library[] = "/mit/StaffTools/lib/xps";
#endif

Init ()
{	
  MakeObject (Nil, (Type) 0);
  Null	  	= Nil.type = MakeType (SizeNull);
  EmptyDict ((Type) Null);	/* needed because of this recursion */
  ...
  Install ("booleantype",	DictFrom (Bool));
