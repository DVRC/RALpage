...
static int For (), PFor (), Eq (), Lt (), Le (), Gt (), Ge (), Not ();
static int And (), Or (), Xor (), BitShift (), Abs (), Add (), Sub ();
static int Mul (), Div (), Mod (), Neg (), Exp (), Sqrt (), Sin ();
static int Cos (), Atan (), Ln (), Log (), Identity (), Cvr (), Cvs ();
static int EqEq ();

static int WordSize, Word2, LowMask;

#define Body(O) (O.u.Integer)
...
InitInteger ()
{
  ...
  TypeInstallOp (Integer, "cvs",	Cvs,		2, 1, 0, 0, Integer,
		 String);
  TypeInstallOp (Integer, "==", 	EqEq,		1, 0, 0, 0, Integer);
  TypeInstallOp (Integer, "for",	PFor, 		4, 0, 0, 6, Integer,
		 Integer, Integer, Array);
  TypeInstallOp (Integer, "eq",		Eq,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "lt",		Lt,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "le",		Le,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "gt",		Gt,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "ge",		Ge,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "not",	Not,		1, 1, 0, 0, Integer);
  TypeInstallOp (Integer, "and",	And,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "or",		Or,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "xor",	Xor,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "bitshift", 	BitShift,	2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "abs",	Abs,		1, 1, 0, 0, Integer);
  TypeInstallOp (Integer, "add",	Add,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "sub",	Sub,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "mul",	Mul,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "div",	Div,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "mod",	Mod,		2, 1, 0, 0, Integer,
		 Integer);
  TypeInstallOp (Integer, "neg",	Neg,		1, 1, 0, 0, Integer);
  TypeInstallOp (Integer, "exp",	Exp,		2, 1, 0, 0, Integer,
		 Integer);
  ...
  TypeInstallOp (Integer, "atan", 	Atan,		2, 1, 0, 0, Integer,
		 Integer);
...
Object MakeInteger (i)
     int i;
{
  Object res;
  
  MakeObject (res, Integer);
  res.u.Integer = i;
  
  return res;
}

static Object Make (i)
     int i;
{
  Object res;
...
static int PFor (initial, increment, limit, proc)
       Object initial, increment, limit, proc;
{
